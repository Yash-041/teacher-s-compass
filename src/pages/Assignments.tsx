...
const assignments = [
  ...
  { title: "UML Diagrams Project", course: "CSC-501", due: "Mar 25, 2026", submissions: 0, total: 44, status: "draft" },
];

const statusConfig = {
  active: { label: "Active", icon: Clock, cls: "bg-primary/10 text-primary" },
  grading: { label: "Awaiting Grading", icon: AlertTriangle, cls: "bg-warning/10 text-warning" },
